...
{
    /// <summary>
    /// (this comes for free with VS and hasn't really been touched)
    /// 
    ...
    public class NavigationHelper : DependencyObject
    {
        ...
        public RelayCommand GoBackCommand
        {
            get
            {
                ...
                {
                    _goBackCommand = new RelayCommand(CanGoBack, GoBack);
                }
        ...
        public RelayCommand GoForwardCommand
        {
            get
            {
                ...
                {
                    _goForwardCommand = new RelayCommand(CanGoForward, GoForward);
                }
